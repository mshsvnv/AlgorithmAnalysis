...
\lstinputlisting[label=lst:vin, caption=Функция умножения матриц методом Винограда, firstline=38,lastline=80]{../code/src/multiply.cpp}

\clearpage

\lstinputlisting[label=lst:vin_opt, caption=Оптимизированная функция умножения матриц методом Винограда, firstline=82,lastline=132]{../code/src/multiply.cpp}

\clearpage

\lstinputlisting[label=lst:strassen, caption=Функция умножения матриц методом Штрассена, firstline=134,lastline=187]{../code/src/multiply.cpp}
