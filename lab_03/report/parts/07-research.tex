...
Результаты замеров времени приведены в таблицах \ref{tbl:time_asc}--\ref{tbl:time_dec}.
...
\begin{table}[h!]
	...
	\centering
		\begin{tabular}{|c|c|c|}
			\hline
			& \multicolumn{3}{c|}{Время, мкс} \\ \cline{2-5}
...
% Затраты по памяти прдеставлены в таблице~\ref{} и на рисунке~\ref{}.
\section*{Вывод}
